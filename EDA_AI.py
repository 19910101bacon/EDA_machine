...
from Var_Analysis.Nominal.nominal_analysis import Nominal
...
with concurrent.futures.ProcessPoolExecutor() as executor:
    ...
    for i in range(len(All_Combination)):
        ...
        for j in range(num):
            ...
            elif Adjust_Var.iloc[1,list(All_Combination[i].keys())[j]] == 'Nominal':
                Index = Nominal(Data, var, Index)

        result = result.append(Pair_Var_Analysis(Data, Index, Adjust_Var, Target_Var, condition_num, 0.2))
